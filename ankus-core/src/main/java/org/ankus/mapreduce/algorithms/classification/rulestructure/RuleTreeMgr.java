...
public class RuleTreeMgr {
    ...
    public RuleTree loadTree(String[] readLines)
    {
        /**
    ...
    public String getCurrentNodeInfoStr(RuleTree node)
    {
     ...
     * Reference Codes..
     */
    public void printLevelNodes(RuleTree node, int level)
    {
        int depth = 0;
        RuleTree tempChild = node;
        RuleTree tempParent = node;
    ...
    public void printChildrenNodes(RuleTree node, int depth)
    {
