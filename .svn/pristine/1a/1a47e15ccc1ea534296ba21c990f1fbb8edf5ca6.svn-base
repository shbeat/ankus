...
public class RuleTree {
    ...
    private RuleTree leftChild = null;      // child node
    private RuleTree rightSibling = null;   // sibling node
    ...
    public void setLeftChild(RuleTree leftChild) {
        this.leftChild = leftChild;
    }

    public RuleTree getLeftChild() {
        return leftChild;
    }

    public void setRightSibling(RuleTree rightSibling) {
        this.rightSibling = rightSibling;
    }

    public RuleTree getRightSibling() {
        return rightSibling;
    }
}
